...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(299)(module), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xmlPrefix = '<?xml version="1.0" encoding="UTF-8" ?>'; // xml prefix
...
/***/ function(module, exports) {
	...
	function ajax(url, options) {
	    ...
	    if (typeof options === 'undefined' && (typeof url === 'undefined' ? 'undefined' : _typeof(url)) === 'object' && url.url) {
	        options = url;
	        url = options.url;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function appendStyle(style, doc) {
	    if (!_lodash2.default.isString(style) || !doc) {
	        console.log('invalid document or style string...', style, doc);
	        return;
	    }
	    var docEl = doc.getElementsByTagName('document').item(0);
	    var styleString = ['<style>', style, '</style>'].join('');
	...
	function prepareDom(doc) {
	    ...
	    _handler2.default.addAll(doc, cfg);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handlers = {
	    select: {
	        ...
	        onLinkClick: function onLinkClick(e) {
	            ...
	            var page = element.getAttribute(hrefAttribute);
	            var replace = element.getAttribute(hrefPageReplaceAttribute);

	            if (!page) return;

	            var options = element.getAttribute(hrefOptionsAttribute);
	            options = options || "{}";
	            ...
	            _navigation2.default.navigate(page, options, replace); // perform navigation
	        },
	         ...
	         */
	        onModalCloseBtnClick: function onModalCloseBtnClick(e) {
	            var element = e.target;
	            var closeBtn = element.getAttribute(modalCloseBtnAttribute);
	        ...
	        onMenuItemSelect: function onMenuItemSelect(e) {
	            var element = e.target;
	            var menuId = element.getAttribute('id');
	...
	function setListeners(doc) {
	    ...
	    var listenerFn = doc.addEventListener;
	    if (!add) {
	 ...
	 * @param {Boolean} [add=true]      Whether to add or remove listeners. Defaults to true (add)
	 */
	function setDefaultHandlers(doc) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getLoaderDoc(message) {
	    ...
	    var str = tpl && tpl({ message: message }) || '<document></document>';

	    return _parser2.default.dom(str);
	}
	...
	function show() {
	    ...
	    if (_lodash2.default.isFunction(cfg)) {
	        cfg = {
	            template: cfg
	        };
	    }
	...
	function showLoading() {
	    ...
	    _lodash2.default.defaultsDeep(cfg, {
	...
	function cleanNavigate(doc) {
	    ...
	    _lodash2.default.delay(dismissModal, 2000);
	...
	function pop(doc) {
	    if (doc instanceof Document) {
	        _lodash2.default.defer(function () {
	            return navigationDocument.popToDocument(doc);
	        });
	    } else {
	        _lodash2.default.defer(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setAttributes(el, attributes) {
	    ...
	    _lodash2.default.each(attributes, function (value, name) {
	...
	function addItem() {
	    ...
	    var el = doc.createElement('menuItem');
	    // assign unique id
	    item.attributes = _lodash2.default.assign({}, item.attributes, {
	        id: item.id
	    });
	    // add all attributes
	    setAttributes(el, item.attributes);
	    // add title
	    el.innerHTML = '<title>' + (_lodash2.default.isFunction(item.name) ? item.name() : item.name) + '</title>';
	    // add page reference
	    el.page = item.page;
	    // appends to the menu
	...
	function setDocument(doc, menuItemid) {
	    var menuItem = itemsCache[menuItemid];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_atvjs__);


const template = ({ message = 'Loading...' }) => `
<document>
    <loadingTemplate>
        <activityIndicator>
            <title>${message}</title>
...
/* unused harmony default export */ var _unused_webpack_default_export = (__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Page.create(config));
...
const getPath = resource => {
    const apiKey = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Settings.get('apiKey');
...
const prepareUrl = (input, options = {}) => {
    if (input.indexOf('?') === -1 && input.indexOf('apiKey=') === -1) {
        input = `${input}?api_key=${__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Settings.get('apiKey')}`;
    }
...
/* harmony export (immutable) */ __webpack_exports__["b"] = prepareUrl;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_atvjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_fetch__ = __webpack_require__(2);
...
const getLatestVideosPromise = () => {
    return __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(`${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["a" /* getPath */])('videos')}&limit=16`)
        .then(response => {
            const results = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.results', []);

            const latest = results.map(result => {
                const item = {
                    detailUrl: __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(result, 'api_detail_url'),
                    name: result.name,
                    description: result.deck,
                    image: __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(result, 'image.screen_url')
                };
...
const getStreamingVideoPromise = () => {
    return __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["a" /* getPath */])('video/current-live/'))
        .then(response => {
            const video = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.video');
            let stream = null;
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Page.create(config));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_atvjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_fetch__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_play__ = __webpack_require__(6);
...
const Page = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Page.create({
    name: 'video',
    template: template,
    events: {
        select: 'onSelect'
    ...
    onSelect(e) {
        ...
        if (!page) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common_play__["a" /* default */])({ url: options.mediaUrl, videoId: options.videoId, resumeVideo });
            return;
        }
        return;
    },
    ready(options = {}, resolve, reject) {
        if (!options.detailUrl || options.detailUrl == "null") {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common_play__["a" /* default */])({ url: options.video });
            resolve();
            return;
        }
        __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["b" /* prepareUrl */])(options.detailUrl))
            .then(response => {
                const result = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.results', {});
                const data = {
                    id: result.id,
                    title: result.name,
            ...
            .then(data => {
                return __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["b" /* prepareUrl */])(`${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["a" /* getPath */])('video/get-saved-time/')}&video_id=${data.id}`))
                    .then(response => {
                        data.savedTime = Math.floor(__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.savedTime', -1));
                        if (data.savedTime < 0) {
                            data.savedTime = 0;
...
const generateShowPromise = ({ name, id, type }) => {
    const url = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["b" /* prepareUrl */])(`${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_fetch__["a" /* getPath */])('videos')}&filter=${type}:${id}&limit=10`);

    return __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(url)
        .then((response) => {
            let videos = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.results', []).map(video => {
                return {
                    url: video.api_detail_url,
                    name: video.name,
                    image: __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(video, 'image.screen_url')
                };
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_atvjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_atvjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_Home__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_Loading__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_Video__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.start({
    templates: {
        loader: __WEBPACK_IMPORTED_MODULE_2__pages_Loading__["a" /* template */],
        error: errorTpl
    },
    menu: {
        attributes: {},
        items: [{
            id: 'home',
            name: 'Home',
            page: __WEBPACK_IMPORTED_MODULE_1__pages_Home__["a" /* default */]
        }]
    },
    onLaunch(options) {
        const apiKey = __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Settings.get('apiKey');
        if (apiKey) {
            __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Navigation.navigateToMenuPage();
        } else {
...
const _timeEventHandlerGenerator = videoId => e => {
    ...
    const url = `${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__fetch__["a" /* getPath */])('video/save-time/')}&video_id=${videoId}&time_to_save=${time}&format=json`;
    __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.post(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__fetch__["b" /* prepareUrl */])(url, { skipFormat: true }));
};

const _play = (url, mediaType, resumeVideo, savedTime=0) => {
    const video = new MediaItem(mediaType, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__fetch__["b" /* prepareUrl */])(url));
...
/* unused harmony export _play */


function play({ url, mediaType='video', videoId, resumeVideo=true }) {
    if (!videoId) {
        _play(url, mediaType, false);
        return;
    }
    __WEBPACK_IMPORTED_MODULE_0_atvjs___default.a.Ajax.get(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__fetch__["b" /* prepareUrl */])(`${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__fetch__["a" /* getPath */])('/video/get-saved-time/')}&video_id=${videoId}`))
        .then(response => {
            const savedTime = Math.floor(__WEBPACK_IMPORTED_MODULE_0_atvjs___default.a._.get(response, 'response.savedTime', -1));
